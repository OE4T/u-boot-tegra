...
#define DISP_COMMAND_RAISE_RANGE	0:0
#define CTRL_MODE_RANGE		6:5
enum {
	CTRL_MODE_STOP,
	CTRL_MODE_C_DISPLAY,
	CTRL_MODE_NC_DISPLAY,
};
#define DISP_COMMAND_RAISE_VECTOR_RANGE	26:22
...
#define PW0_ENABLE_RANGE		0:0
#define PW1_ENABLE_RANGE		2:2
#define PW2_ENABLE_RANGE		4:4
#define PW3_ENABLE_RANGE		6:6
#define PW4_ENABLE_RANGE		8:8
#define PM0_ENABLE_RANGE		16:16
#define PM1_ENABLE_RANGE		18:18
#define SPI_ENABLE_RANGE		24:24
#define HSPI_ENABLE_RANGE		25:25

/* DC_CMD_STATE_CONTROL 0x041 */
#define GENERAL_ACT_REQ_RANGE		0:0
#define WIN_A_ACT_REQ_RANGE		1:1
#define WIN_B_ACT_REQ_RANGE		2:2
#define WIN_C_ACT_REQ_RANGE		3:3
#define GENERAL_UPDATE_RANGE		8:8
#define WIN_A_UPDATE_RANGE		9:9
#define WIN_B_UPDATE_RANGE		10:10
#define WIN_C_UPDATE_RANGE		11:11

/* DC_CMD_DISPLAY_WINDOW_HEADER 0x042 */
#define WINDOW_A_SELECT_RANGE		4:4
#define WINDOW_B_SELECT_RANGE		5:5
#define WINDOW_C_SELECT_RANGE		6:6

/* DC_DISP_DISP_CLOCK_CONTROL 0x42e */
#define SHIFT_CLK_DIVIDER_RANGE		7:0
#define	PIXEL_CLK_DIVIDER_RANGE		11:8
enum {
...
#define DATA_ALIGNMENT_RANGE	8:8
enum {
	DATA_ALIGNMENT_MSB,
	DATA_ALIGNMENT_LSB,
};
#define DATA_ORDER_RANGE		9:9
enum {
	DATA_ORDER_RED_BLUE,
	DATA_ORDER_BLUE_RED,
};
...
#define H_DIRECTION_RANGE		0:0
enum {
	H_DIRECTION_INCREMENT,
	H_DIRECTION_DECREMENT,
};
#define V_DIRECTION_RANGE		2:2
enum {
	V_DIRECTION_INCREMENT,
	V_DIRECTION_DECREMENT,
};
#define COLOR_EXPAND_RANGE		6:6
#define CP_ENABLE_RANGE			16:16
#define DV_ENABLE_RANGE			20:20
#define WIN_ENABLE_RANGE		30:30

/* DC_WIN_BYTE_SWAP 0x701 */
#define BYTE_SWAP_RANGE			1:0
enum {
	BYTE_SWAP_NOSWAP,
	BYTE_SWAP_SWAP2,
	BYTE_SWAP_SWAP4,
...
#define H_POSITION_RANGE		12:0
#define V_POSITION_RANGE		28:16

/* DC_WIN_SIZE 0x705 */
#define H_SIZE_RANGE			12:0
#define V_SIZE_RANGE			28:16

/* DC_WIN_PRESCALED_SIZE 0x706 */
#define H_PRESCALED_SIZE_RANGE		14:0
#define V_PRESCALED_SIZE_RANGE		28:16
