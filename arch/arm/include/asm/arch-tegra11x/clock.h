...
/* Tegra11x clock control functions */
...
enum clock_id {
	...
	/*
	 * The clock id that is used in table clock_source[][]
	 * but will not be assigned as clock source for any peripherals.
	 */
	CLOCK_ID_DISPLAY2_RESERVED,
	CLOCK_ID_CGENERAL2_RESERVED,
	CLOCK_ID_CGENERAL3_RESERVED,
	CLOCK_ID_MEMORY2_RESERVED,
	CLOCK_ID_SRC2_RESERVED,
...
enum periph_id {
	...
	PERIPH_ID_COUNT,
	PERIPH_ID_DVC_I2C = PERIPH_ID_I2C5,
};
 ...
 *
 * @param cpu		cpu number (0 ~ 3 on Tegra)
