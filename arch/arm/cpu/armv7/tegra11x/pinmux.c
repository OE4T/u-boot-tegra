...
const struct tegra_pingroup_desc tegra_soc_pingroups[PINGRP_COUNT] = {
	...
	PIN(DAP3_FS,	BB,	    I2S2,	SPI5,	    DISPLAYA,	DISPLAYB,    RSVD,	INPUT),
	PIN(DAP3_DIN,	BB,	    I2S2,	SPI5,	    DISPLAYA,	DISPLAYB,    RSVD,	INPUT),
	PIN(DAP3_DOUT,	BB,	    I2S2,	SPI5,	    DISPLAYA,	DISPLAYB,    RSVD,	INPUT),
	PIN(DAP3_SCLK,	BB,	    I2S2,	SPI5,	    DISPLAYA,	DISPLAYB,    RSVD,	INPUT),
	...
	PIN(GPIO_PU0,	UART,	    OWR,	UARTA,	    RSVD2,	RSVD3,	     RSVD,	INPUT),
	PIN(GPIO_PU1,	UART,	    RSVD0,	UARTA,	    RSVD2,	RSVD3,	     RSVD,	INPUT),
	PIN(GPIO_PU2,	UART,	    RSVD0,	UARTA,	    RSVD2,	RSVD3,	     RSVD,	INPUT),
	PIN(GPIO_PU3,	UART,	    PWM0,	UARTA,	    DISPLAYA,	DISPLAYB,    RSVD,	INPUT),
	PIN(GPIO_PU4,	UART,	    PWM1,	UARTA,	    DISPLAYA,	DISPLAYB,    RSVD,	INPUT),
	PIN(GPIO_PU5,	UART,	    PWM2,	UARTA,	    DISPLAYA,	DISPLAYB,    RSVD,	INPUT),
	PIN(GPIO_PU6,	UART,	    PWM3,	UARTA,	    USB,	DISPLAYB,    RSVD,	INPUT),
	...
	PIN(GMI_IORDY,	GMI,	    SDMMC2,	RSVD1,	    GMI,	TRACE,	     RSVD,	INPUT),
	PIN(GMI_WAIT,	GMI,	    SPI4,	NAND,	    GMI,	DTV,	     RSVD,	INPUT),
	PIN(GMI_ADV_N,	GMI,	    RSVD0,	NAND,	    GMI,	TRACE,	     RSVD,	INPUT),
	PIN(GMI_CLK,	GMI,	    SDMMC2,	NAND,	    GMI,	TRACE,	     RSVD,	INPUT),
	PIN(GMI_CS0_N,	GMI,	    RSVD0,	NAND,	    GMI,	USB,	     RSVD,	INPUT),
	PIN(GMI_CS1_N,	GMI,	    RSVD0,	NAND,	    GMI,	SOC,	     RSVD,	INPUT),
	PIN(GMI_CS2_N,	GMI,	    SDMMC2,	NAND,	    GMI,	TRACE,	     RSVD,	INPUT),
	PIN(GMI_CS3_N,	GMI,	    SDMMC2,	NAND,	    GMI,	GMI_ALT,     RSVD,	INPUT),
	PIN(GMI_CS4_N,	GMI,	    USB,	NAND,	    GMI,	TRACE,	     RSVD,	INPUT),
	...
	PIN(GMI_A16,	GMI,	    UARTD,	TRACE,	    GMI,	GMI_ALT,     RSVD,	INPUT),
	PIN(GMI_A17,	GMI,	    UARTD,	RSVD1,	    GMI,	TRACE,	     RSVD,	INPUT),
	PIN(GMI_A18,	GMI,	    UARTD,	RSVD1,	    GMI,	TRACE,	     RSVD,	INPUT),
	PIN(GMI_A19,	GMI,	    UARTD,	SPI4,	    GMI,	TRACE,	     RSVD,	INPUT),
	PIN(GMI_WR_N,	GMI,	    RSVD0,	NAND,	    GMI,	SPI4,	     RSVD,	INPUT),
	PIN(GMI_OE_N,	GMI,	    RSVD0,	NAND,	    GMI,	SOC,	     RSVD,	INPUT),
	PIN(GMI_DQS_P,	GMI,	    SDMMC2,	NAND,	    GMI,	TRACE,	     RSVD,	INPUT),
	...
	PIN(SDMMC4_RST_N,	SDMMC4,     RSVD0,	RSVD1,	    RSVD2,	SDMMC4,	     RSVD,	INPUT),
	PIN(CAM_MCLK,	CAM,	    VI,		VI_ALT1,    VI_ALT2,	RSVD3,	     RSVD,	INPUT),
	...
	PIN(GPIO_PBB3,	CAM,	    VGP3,	DISPLAYA,   DISPLAYB,	RSVD3,	     RSVD,	INPUT),
	PIN(GPIO_PBB4,	CAM,	    VGP4,	DISPLAYA,   DISPLAYB,	RSVD3,	     RSVD,	INPUT),
	PIN(GPIO_PBB5,	CAM,	    VGP5,	DISPLAYA,   DISPLAYB,	RSVD3,	     RSVD,	INPUT),
	PIN(GPIO_PBB6,	CAM,	    VGP6,	DISPLAYA,   DISPLAYB,	RSVD3,	     RSVD,	INPUT),
	...
	PIN(KB_ROW0,	SYS,	    KBC,	RSVD1,	    DTV,	RSVD3,	     RSVD,	INPUT),
	PIN(KB_ROW1,	SYS,	    KBC,	RSVD1,	    DTV,	RSVD3,	     RSVD,	INPUT),
	PIN(KB_ROW2,	SYS,	    KBC,	RSVD1,	    DTV,	SOC,	     RSVD,	INPUT),
	PIN(KB_ROW3,	SYS,	    KBC,	DISPLAYA,   RSVD2,	DISPLAYB,    RSVD,	INPUT),
	PIN(KB_ROW4,	SYS,	    KBC,	DISPLAYA,   SPI2,	DISPLAYB,    RSVD,	INPUT),
	PIN(KB_ROW5,	SYS,	    KBC,	DISPLAYA,   SPI2,	DISPLAYB,    RSVD,	INPUT),
	PIN(KB_ROW6,	SYS,	    KBC,	DISPLAYA,   INVALID,	DISPLAYB,    RSVD,	INPUT),
	PIN(KB_ROW7,	SYS,	    KBC,	RSVD1,	    CLDVFS,	UARTA,	     RSVD,	INPUT),
	PIN(KB_ROW8,	SYS,	    KBC,	RSVD1,	    RSVD2,	UARTA,	     RSVD,	INPUT),
	PIN(KB_ROW9,	SYS,	    KBC,	RSVD1,	    RSVD2,	UARTA,	     RSVD,	INPUT),
	PIN(KB_ROW10,	SYS,	    KBC,	RSVD1,	    RSVD2,	UARTA,	     RSVD,	INPUT),
	PIN(KB_COL0,	SYS,	    KBC,	USB,	    SPI2,	EMC_DLL,     RSVD,	INPUT),
	PIN(KB_COL1,	SYS,	    KBC,	RSVD1,	    SPI2,	EMC_DLL,     RSVD,	INPUT),
	PIN(KB_COL2,	SYS,	    KBC,	RSVD1,	    SPI2,	RSVD,	     RSVD,	INPUT),
	PIN(KB_COL3,	SYS,	    KBC,	DISPLAYA,   PWM2,	UARTA,	     RSVD,	INPUT),
	PIN(KB_COL4,	SYS,	    KBC,	OWR,	    SDMMC3,	UARTA,	     RSVD,	INPUT),
	...
	PIN(SPI2_MOSI,	AUDIO,      SPI6,	CLDVFS,	    RSVD2,	RSVD3,	     RSVD,	INPUT),
	PIN(SPI2_MISO,	AUDIO,      SPI6,	RSVD1,	    RSVD2,	RSVD3,	     RSVD,	INPUT),
	PIN(SPI2_CS0_N,	AUDIO,      SPI6,	SPI1,	    RSVD2,	RSVD3,	     RSVD,	INPUT),
	PIN(SPI2_SCK,	AUDIO,      SPI6,	CLDVFS,	    RSVD2,	RSVD3,	     RSVD,	INPUT),
	PIN(SPI1_MOSI,	AUDIO,      RSVD0,	SPI1,	    SPI2,	DAP2,	     RSVD,	INPUT),
	PIN(SPI1_SCK,	AUDIO,      RSVD0,	SPI1,	    SPI2,	RSVD3,	     RSVD,	INPUT),
	PIN(SPI1_CS0_N,	AUDIO,      SPI6,	SPI1,	    SPI2,	RSVD3,	     RSVD,	INPUT),
	PIN(SPI1_MISO,	AUDIO,      RSVD0,	SPI1,	    SPI2,	RSVD3,	     RSVD,	INPUT),
	...
	PIN(SDMMC3_CD_N,	SDMMC3,     SDMMC3,	OWR,	    RSVD2,	RSVD3,	     RSVD,	INPUT),
	PIN(SPI1_CS1_N,	AUDIO,      SPI6,	RSVD1,	    SPI2,	I2C1,	     RSVD,	INPUT),
	PIN(SPI1_CS2_N,	AUDIO,      SPI6,	SPI1,	    SPI2,	I2C1,	     RSVD,	INPUT),
	PIN(USB_VBUS_EN0,	SYS,        USB,	RSVD1,	    RSVD2,	RSVD3,	     RSVD,	INPUT),
	PIN(USB_VBUS_EN1,	SYS,        USB,	RSVD1,	    RSVD2,	RSVD3,	     RSVD,	INPUT),
	PIN(SDMMC3_CLK_LB_IN,	SDMMC3,     SDMMC3,	RSVD1,	    RSVD2,	RSVD3,	     RSVD,	INPUT),
	PIN(SDMMC3_CLK_LB_OUT,	SDMMC3,     SDMMC3,	RSVD1,	    RSVD2,	RSVD3,	     RSVD,	OUTPUT),
	PIN(NAND_GMI_CLK_LB,	GMI,        SDMMC2,	NAND,	    GMI,	RSVD3,	     RSVD,	OUTPUT),
