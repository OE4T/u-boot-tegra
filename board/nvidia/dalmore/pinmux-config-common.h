...
static struct pingroup_config tegra114_pinmux_common[] = {
	...
	DEFAULT_PINMUX(SDMMC3_CLK_LB_OUT,  SDMMC3,      UP,   TRISTATE,   INPUT),
	DEFAULT_PINMUX(SDMMC3_CLK_LB_IN,   SDMMC3,      DOWN,   NORMAL,   INPUT),
	...
	DEFAULT_PINMUX(KB_ROW7,       RSVD,   UP,   NORMAL,      INPUT),
...
static struct pingroup_config tegra114_pinmux_set_nontristate[] = {
	DEFAULT_PINMUX(GPIO_X4_AUD,     RSVD,   DOWN,    NORMAL,    OUTPUT),
	DEFAULT_PINMUX(GPIO_X5_AUD,     RSVD,   UP,      NORMAL,    INPUT),
	DEFAULT_PINMUX(GPIO_X6_AUD,     RSVD3,  UP,      NORMAL,    INPUT),
	DEFAULT_PINMUX(GPIO_X7_AUD,     RSVD,   DOWN,    NORMAL,    OUTPUT),
	...
	DEFAULT_PINMUX(GMI_DQS_P,       GMI,    UP,      NORMAL,    INPUT),
	...
	DEFAULT_PINMUX(HDMI_INT,	RSVD,	DOWN,		NORMAL,	INPUT),
