...
static struct pingroup_config tegra3_pinmux_common[] = {
	...
	/* SDMMC4 pinmux */
	VI_PINMUX(SDMMC4_CLK,	SDMMC4,	NORMAL,	NORMAL,	INPUT,	DISABLE,	DISABLE),
	VI_PINMUX(SDMMC4_CMD,	SDMMC4,	UP,	NORMAL,	INPUT,	DISABLE,        DISABLE),
	VI_PINMUX(SDMMC4_DAT0,	SDMMC4,	UP,	NORMAL,	INPUT,	DISABLE,        DISABLE),
	VI_PINMUX(SDMMC4_DAT1,	SDMMC4,	UP,	NORMAL,	INPUT,	DISABLE,        DISABLE),
	VI_PINMUX(SDMMC4_DAT2,	SDMMC4,	UP,	NORMAL,	INPUT,	DISABLE,        DISABLE),
	VI_PINMUX(SDMMC4_DAT3,	SDMMC4,	UP,	NORMAL,	INPUT,	DISABLE,        DISABLE),
	VI_PINMUX(SDMMC4_DAT4,	SDMMC4,	UP,	NORMAL,	INPUT,	DISABLE,        DISABLE),
	VI_PINMUX(SDMMC4_DAT5,	SDMMC4,	UP,	NORMAL,	INPUT,	DISABLE,        DISABLE),
	VI_PINMUX(SDMMC4_DAT6,	SDMMC4,	UP,	NORMAL,	INPUT,	DISABLE,        DISABLE),
	VI_PINMUX(SDMMC4_DAT7,	SDMMC4,	UP,	NORMAL,	INPUT,	DISABLE,        DISABLE),
	...
	VI_PINMUX(VI_PCLK,         RSVD1,           UP,   TRISTATE,   INPUT,  DISABLE, DISABLE),
