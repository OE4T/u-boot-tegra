 ...
 * Run "board-to-uboot.py p3450_porg".
 */

#ifndef _PINMUX_CONFIG_P3450_PORG_H_
#define _PINMUX_CONFIG_P3450_PORG_H_
...
static const struct pmux_pingrp_config p3450_porg_pingrps[] = {
	...
	PINCFG(UART2_TX_PG0,         UARTB,      DOWN,   NORMAL,   OUTPUT,  DISABLE, DEFAULT),
	...
	PINCFG(ALS_PROX_INT_PX3,     DEFAULT,    UP,     NORMAL,   OUTPUT,  DISABLE, DEFAULT),
